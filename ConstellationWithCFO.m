...
title('(a) $\varepsilon=0$', 'FontSize', 14, 'Interpreter', 'latex');
xlabel('Real', 'FontSize', 12);
ylabel('Imaginary', 'FontSize', 12);

y = x_GI;  % 忽略信道和噪声的影响
CFO = 0.01;
y_GI = add_CFO(y, CFO, Nfft);
kk1 = 1:Nbit;
kk2 = 1:Nfft;
kk3 = 1:Nused;
...
box on; axis equal;
axis([-1.5,1.5,-1.5,1.5]);
title(['(b) $\varepsilon$ = ', num2str(CFO)], 'FontSize', 14, 'Interpreter', 'latex');
xlabel('Real', 'FontSize', 12);
ylabel('Imaginary', 'FontSize', 12);
...
box on; axis equal;
axis([-1.5,1.5,-1.5,1.5]);
title(['(c) $\varepsilon$ = ', num2str(CFO)], 'FontSize', 14, 'Interpreter', 'latex');
xlabel('Real', 'FontSize', 12);
ylabel('Imaginary', 'FontSize', 12);
...
box on; axis equal;
axis([-1.5,1.5,-1.5,1.5]);
title(['(d) $\varepsilon$ = ', num2str(CFO)], 'FontSize', 14, 'Interpreter', 'latex');
xlabel('Real', 'FontSize', 12);
ylabel('Imaginary', 'FontSize', 12);